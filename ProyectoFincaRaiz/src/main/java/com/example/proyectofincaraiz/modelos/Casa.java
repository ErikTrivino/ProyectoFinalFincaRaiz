...
public class Casa extends Propiedad {
    ...
    public Casa(Integer id, String direccion, Float valorVenta, String area, Integer numCuartos, Integer numBanios, TipoEstado estado, TipoVenta tipoVenta, Usuario usuario, int numeroPisos, String material) {
